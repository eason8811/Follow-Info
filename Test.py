...
plt.plot(list(position_count.keys()), [position_count[i][0]*100000 for i in position_count.keys()], label='long_amount')
plt.plot(list(position_count.keys()), [position_count[i][1]*100000 for i in position_count.keys()], label='short_amount')
plt.legend()
plt.show()
